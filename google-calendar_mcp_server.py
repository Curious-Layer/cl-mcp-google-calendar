...
Provides access to Google Calendar operations through Model Context Protocol
"""
...
logging.basicConfig(
    ...
    handlers=[
        # logging.FileHandler('calendar_mcp_server.log'),
...
mcp = FastMCP("CL Google Calendar MCP Server")
...
def _get_service(token_data: str):
    """Create Google Calendar service with provided access token"""
...
def get_calendar(oauth_token: str, calendar_id: str = "primary") -> Dict:
...
def create_calendar(
    oauth_token: str, summary: str, description: str = "", timezone: str = "UTC"
) -> Dict:
...
def delete_calendar(oauth_token: str, calendar_id: str) -> Dict:
    """Delete a calendar"""
...
def get_event(oauth_token: str, event_id: str, calendar_id: str = "primary") -> Dict:
    """Get event details"""
...
def create_quick_event(
    oauth_token: str, text: str, calendar_id: str = "primary"
) -> Dict:
...
def delete_event(oauth_token: str, event_id: str, calendar_id: str = "primary") -> Dict:
...
def search_events(
    oauth_token: str, query: str, calendar_id: str = "primary", max_results: int = 10
) -> Dict:
...
def get_upcoming_events(
    oauth_token: str, days: int = 7, calendar_id: str = "primary", max_results: int = 10
) -> Dict:
    """Get upcoming events"""
...
def get_todays_events(oauth_token: str, calendar_id: str = "primary") -> Dict:
    """Get today's events"""
...
def get_free_busy(
    oauth_token: str, time_min: str, time_max: str, calendar_ids: List[str] = []
) -> Dict:
